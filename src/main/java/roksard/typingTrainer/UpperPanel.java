...
public class UpperPanel extends JPanel {
	public JLabel getLbCharCount() {
		return lbCharCount;
	}

	public JLabel getLbErrorCount() {
		return lbErrorCount;
	}
	...
	public BtStartActionListener getBtStartActionListener() {
		return btStartActionListener;
	}

	public BtResetActionListener getBtResetActionListener() {
		return btResetActionListener;
	}
	...
	public void updateLbTypingSpeed() { // letters per min
		lbSpeed.setText("Speed: " + String.format("%.0f / Average: %.0f letters/min)",
				session.calcMomentaryTypingSpeed(), session.calcAverageTypingSpeed()));
	}
