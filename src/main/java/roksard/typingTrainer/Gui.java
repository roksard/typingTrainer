...
import roksard.typingTrainer.listeners.ChooseFontActionListener;
import roksard.typingTrainer.listeners.EpTextCaretListener;
...
public class Gui {
	...
	public void start() {
		...
		if (config.getWinX() != null && config.getWinY() != null && config.getWinW() != null
				&& config.getWinH() != null) {
